                        ...
                        <tr>
                            <td>
                                <div class="signup-link">
                                    <span class="signup-text">Chưa có tài khoản? </span><a
                                        href="http://localhost:8080/webVR_war/register"> Đăng ký ngay</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <div class="container-login100-form-btn">
                                    <div class="wrap-login100-form-btn">
                                        ...
                                        <form:button class="login100-form-btn" id="login"
                                                     name="login">Đăng nhập</form:button>
                                    </div>
                                </div>
                            </td>
                        </tr>
